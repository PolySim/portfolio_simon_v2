  ...
  return (
    <div className="group">
      <div
        ...
        className={cn(
          "flex justify-center items-center rounded-full relative size-[120px] cursor-pointer group-hover:scale-90 transition duration-200 skill-box-after md:group-hover:after:-translate-x-1/2 md:group-hover:after:translate-y-1/2 md:group-hover:after:opacity-100 after:content-[attr(data-content)]",
        )}
        style={{
